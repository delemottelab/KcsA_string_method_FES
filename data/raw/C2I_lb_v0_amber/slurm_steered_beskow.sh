...
#SBATCH --job-name=my_steering

# Output file names for stdout and stderr
#SBATCH --error=steer.err
#SBATCH --output=steer.out
...
path_string_method_gmxapi=../../../../string-method-gmxapi_milos
...
cmd="mpiexec -n 1 `which python` ${path_string_method_gmxapi}/main.py --config_file=config_steered.json --start_mode=steered"
echo "Command Run:"
echo $cmd
